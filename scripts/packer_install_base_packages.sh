...
install_envoy () {
    ...
    sudo add-apt-repository \
        ...
        $(lsb_release -cs) \
        stable"
    #sudo apt-get update && sudo apt-get install -y getenvoy-envoy=1.12.2.p0.g55af249-1p49.g8b1f2e3/1.11.1-1~git1565661582.930d4a5
    # Consul docs currently points to envoy 1.11.1...1.11.2.p0.g7a12f37-1p42.gb8451b1
    sudo apt-get update && sudo apt-get install -y getenvoy-envoy=1.11.1-1~git1565661582.930d4a5
    envoy --version
}
